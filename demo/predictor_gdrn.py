...
class GdrnPredictor():
    ...
    def gdrn_visualization(self, batch, out_dict, image, frame_count=0, save_path=None):
        vis_dict = {}
        ...
        if False: #"full_mask" in out_dict:
            ...
            img_vis_full_mask = vis_image_mask_bbox_cv2(
                ...
                labels=[self.objs[batch['roi_cls'][i].detach().cpu().item() + 1] for i in range(bs)],
            )
